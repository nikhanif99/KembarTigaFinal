      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-grey-80 u-group u-group-1">
          <div class="u-container-layout u-container-layout-1" align="center">
			...
			<form id="contact-form" action="AddPayment" method="POST" class="tm-contact-form">
				<table align="center">
				
				
				<h2> Pay By Online </h2>
					
					<tr><td>Booking ID: </td><td><input readonly type="text" name="BOOKINGID" value="<c:out value="${u}"/>" /><br></td></tr>
					<tr><td>Payment Amount: </td><td><input readonly type="number" name="PAYMENTAMOUNT" value="<c:out value="${b.TOTALPRICE}"/>" /><br></td></tr>
					<tr><td>Date: </td><td><input required type="date" name="PAYMENTDATE" value="" min="2021-07-26" /><br></td></tr>
					<tr><td></td><td><input type="hidden" name="PAYMENTTYPE" value="ONLINE PAYMENT" /><br></td></tr>
