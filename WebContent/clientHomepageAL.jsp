...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Welcome to Kembar Tiga Studio, Your Favourite, Photo">
...
<link rel="stylesheet" href="Home.css" media="screen">
    ...
    <link rel="canonical" href="homepage.jsp">
    <meta property="og:url" content="homepage.jsp">
  </head>
  ...
  <body class="u-black u-body"><header class="u-black u-clearfix u-header u-header" id="sec-3091"><div class="u-clearfix u-sheet u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="aboutSessionController?=<c:out value="${sessionCLIENTID}" />" style="padding: 10px 20px;">About</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="clientViewBookingListController?=<c:out value="${sessionCLIENTID}"/>" style="padding: 10px 20px;">My Booking</a>
    ...
    <section class="u-black u-clearfix u-section-1" id="sec-d4f8">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-align-center u-heading-font u-text u-title u-text-1">Welcome to Kembar Tiga Studio</h1>
        <p class="u-align-center u-text u-text-2"  style="text-align: justify;">Kembar Tiga Studio comprise of a team of motivated, committed, efficient and dedicated people with the right attitude who offer consistent professional image, video and graphic design quality and excellent customer service. Our team is given on-going training and mentorship to promote self-development as well as to provide added value to our clients according to our vision.</p>
      </div>
    </section>
    <section class="u-clearfix u-image u-section-2" id="carousel_ae33">
      <div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-left u-clearfix u-image u-section-3" id="carousel_b6a0">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-body-alt-color u-text-1"><b style="">Creative</b> form in our <b>design</b>
        </h2>
        <h5 class="u-text u-text-body-alt-color u-text-2">photo salon</h5>
        <p class="u-text u-text-body-alt-color u-text-3">Our crews are engaged and experienced in Malaysia and well informed about the communities they service.&nbsp;</p>
      </div>
    </section>
