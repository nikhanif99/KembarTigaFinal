        ...
        <div class="u-container-style u-grey-80 u-group u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <div class="u-form u-form-1">
              <form action="clientUpdateBookingController" method="POST">
              	<h2>Your Booking Details : </h2>
              	<div class="u-form-group u-form-name">
                  <label for="name-8aee" class="u-label">Booking ID : </label>
                  <input type="text" placeholder="" id="name-8aee" name="BOOKINGID"  value="<c:out value="${book.BOOKINGID}"/>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" readonly>
                </div><br>
              	<div class="u-form-group u-form-name">
                  <label for="name-8aee" class="u-label">Location : </label>
                  <input type="text" placeholder="" id="name-8aee" name="BOOKINGLOCATION" value="<c:out value="${book.BOOKINGLOCATION}"/>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                </div><br>
                
              	<div class="u-form-group u-form-name">
                	<label for="date-1c81" class="u-label">Type of Service : </label>
               		<select name="SERVICEID" id="SERVICEID" class="select-selected" style="color:black" >
						...
						<option <c:if test="${b.SERVICEID == book.SERVICEID}"><c:out value="selected" /></c:if> value="${b.SERVICEID}" style="color:black" ><c:out value="${b.SERVICETYPE}"/></option>
	                </c:forEach>
                 	</select><br>
	            </div><br>
                <div class="u-form-date u-form-group u-form-group-3">
                  <label for="date-161f" class="u-label">Start Date : </label>
                  <input type="date" id="date-161f" name="BOOKINGSTARTDATE" value="<c:out value="${book.BOOKINGSTARTDATE}"/>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                </div><br>
                <div class="u-form-date u-form-group u-form-group-4">
                  <label for="date-487a" class="u-label">End Date : </label>
                  <input type="date" placeholder="" id="date-487a" name="BOOKINGENDDATE" value="<c:out value="${book.BOOKINGENDDATE}"/>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                </div><br>
                <div class="u-form-group u-form-name">
                  <label for="date-1c81" class="u-label">Hours : </label>
                  <input type="text" placeholder="" id="name-8aee" name="HOURS" value="<c:out value="${book.HOURS}"/>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                </div>
                <br>
