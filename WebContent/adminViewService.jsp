...
<body><div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div><center><h2>Service <b>List</b></h2></center></div>
                        <div class="col-sm-4">
                ...
                <table class="table table-striped table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>SERVICE ID<i class="fa fa-sort"></i></th>
                            <th>SERVICE TYPE<i class="fa fa-sort"></i></th>
                            <th>SERVICE RATES/HOUR</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${psnlistservice}" var="service">
                        <tr>
                            
                            <td><c:out value="${service.SERVICEID}" /></td>
                            <td><c:out value="${service.SERVICETYPE}" /></td>
                            <td><c:out value="${service.EDITINGRATE}" /></td>
                          
                            
                            <td>
                                <a href="updateServiceController?SERVICEID=<c:out value="${service.SERVICEID}" />" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                <a onclick ="myFunction()" href="deleteServiceController?SERVICEID=<c:out value="${service.SERVICEID}" />" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                            </td>
                        </tr>
                        </c:forEach>     
                    </tbody>
...
<center><button><a href="newServiceForm.jsp">Add New Service</a></button></center><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
