...
<body><div class="table-wrapper">
              ...
              <center> <h1 style="color:black">Add New Service</h1><br>
<fieldset STYLE="TEXT-ALIGN:CENTER; width:500px;">

<label for="STAFFID" style="color:black"><b>Enter Service Type</b></label><br>
<input type="text" style="color:black" placeholder="Service Type" name="SERVICETYPE" required><br><br>

<label for="STAFFNAME" style="color:black"><b>Enter Rates per/Hour(RM)</b></label><br>
<input type="text" style="color:black" placeholder="Rates/hrs" name="EDITINGRATE" required><br><br>
