          ...
          <div class="u-container-layout u-container-layout-1" align="center">
			...
			<table><th>
				...
				<table align="center">
					...
					<tr><td>Booking ID: </td><td><input required type="text" name="BOOKINGID" value="<c:out value="${u}"/>" /><br></td></tr>
					<tr><td></td><td><input type="hidden" name="PAYMENTTYPE" value="CASH" /><br></td></tr>
					<tr><td>Payment Amount: </td><td><input readonly type="number" name="PAYMENTAMOUNT" value="<c:out value="${b.TOTALPRICE}"/>" /><br></td></tr>
					<tr><td>Date: </td><td><input type="date" required name="PAYMENTDATE" value="" min="2021-07-26" /><br></td></tr>
					<tr><td>Status: </td><td>
					<select name="CASHSTATUS" style="color:black;">
					<option value="PAY DURING SHOOT SESSION" >PAY DURING SHOOT SESSION</option>
					<option value="PAY AFTER SHOOT SESSION FINISH " >PAY AFTER SHOOT SESSION FINISH</option>
					</select>
					</td>
					</tr>
