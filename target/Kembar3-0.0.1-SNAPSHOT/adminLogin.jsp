...
<form action="adminLoginController" method="POST" style="margin:20px">
<h1 style="color:black">LOGIN</h1><br>
<fieldset STYLE="TEXT-ALIGN:CENTER; width:500px;">

<label for="STAFFEMAIL" style="color:black"><b>Enter Email</b></label><br>
<input type="text" style="color:black" placeholder="STAFF EMAIL" name="STAFFEMAIL" required><br><br>

<label for="STAFFPASS" style="color:black"><b>Enter Password</b></label><br>
<input type="password" style="color:black" placeholder="Staff PASS" name="STAFFPASS" required><br><br>
