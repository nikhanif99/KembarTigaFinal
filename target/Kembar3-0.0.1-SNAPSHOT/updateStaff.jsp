...
<form action="updateStaffController" method="POST" style="margin:20px">
<h1 style="color:black">Update Staff Details</h1><br>
<fieldset STYLE="TEXT-ALIGN:CENTER; width:500px;">

<label for="STAFFID" style="color:black"><b>Staff ID</b></label><br>
<input type="text" style="color:black" name="STAFFID" value="<c:out value="${s.STAFFID}"/>" readonly><br><br>

<label for="STAFFNAME" style="color:black"><b>Staff Name</b></label><br>
<input type="text" style="color:black"  name="STAFFNAME" value="<c:out value="${s.STAFFNAME}"/>"><br><br>

<label for="STAFFPHONENO" style="color:black"><b>Staff Phone Number</b></label><br>
<input type="text" style="color:black"  name="STAFFPHONENO" value="<c:out value="${s.STAFFPHONENO}"/>"><br><br>

<label for="STAFFROLE" style="color:black"><b>Staff Role</b></label><br>
<input type="text" style="color:black" name="STAFFROLE" value="<c:out value="${s.STAFFROLE}"/>"><br><br>

<label for="STAFFEMAIL" style="color:black"><b>Staff Email</b></label><br>
<input type="text" style="color:black" name="STAFFEMAIL" value="<c:out value="${s.STAFFEMAIL}"/>"><br><br>

<label for="STAFFEPASS" style="color:black"><b>CHANGE PASSWORD</b></label><br>
<input type="password" style="color:black" name="STAFFPASS" value="<c:out value="${s.STAFFPASS}"/>"><br><br>
