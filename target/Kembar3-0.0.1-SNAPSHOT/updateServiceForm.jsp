...
<body><div class="table-wrapper">
              ...
              <center> <h1 style="color:black">Update Service Details</h1><br>
<fieldset STYLE="TEXT-ALIGN:CENTER; width:500px;">


<b>Service ID</b><br>
<input type="text" readonly name="SERVICEID" value="<c:out value="${s.SERVICEID}" />" required />
<br><br>
<b>Service Type</b><br>
<input type="text" name="SERVICETYPE" value="<c:out value="${s.SERVICETYPE}" />" required />
<br><br>
<b>Editing Rate/hours (RM)</b><br>
<input type="text"  name="EDITINGRATE" value="<c:out value="${s.EDITINGRATE}" />" required />
<br><br><br>
...
<center><button onclick="location.href='staffViewServiceController';" style=" vertical-align:middle"><span>BACK TO LIST</span></button></center>
            </div>
