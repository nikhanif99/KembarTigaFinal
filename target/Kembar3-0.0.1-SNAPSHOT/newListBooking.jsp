...
<li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="clientListMS.jsp" style="padding: 10px 20px;">Clients</a></li>
    ...
    <section class="u-black u-clearfix u-section-1" id="sec-f2f6">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-1">New Booking List</h2>
          <div class="u-container-layout u-container-layout-1">
          <div class="myDiv">
            <table class="w3-table-all" id="t01">
						<tr class="w3-gray">
							<th width="1%">No</th>
							<th width="1%">Staff ID</th>
							<th width="1%">Client ID</th>
						...
						<c:set var = "count" value = "${count+1}"/>
							<tr>
								...
								<td><c:set var="TOTALPRICE" value="${TOTALPRICE+b.EDITINGRATE*b.HOURS}"/>
								<c:out value = "${TOTALPRICE}"/>
								</td>	
								<td><c:out value="${b.BOOKINGSTATUS}" /></td>
								
								<td><a href="UpdateApproval?BOOKINGID=<c:out value="${b.BOOKINGID}" />"><p>
											<button class="w3-btn w3-block w3-blue" href="UpdateApproval.jsp">Update</button>
										</p></a></td>
								<td><a href="DeleteBooking?BOOKINGID=<c:out value="${b.BOOKINGID}" />"><p>
											<button class="w3-btn w3-block w3-red " href="bookingform.jsp">Delete</button>
										</p></a></td> 
						</c:forEach>
					</table>
            </div>
