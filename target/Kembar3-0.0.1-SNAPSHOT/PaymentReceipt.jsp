        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Home.html" style="padding: 10px 20px;">Home</a>
				...
				</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="bookingHistory.html" style="padding: 10px 20px;">My Booking</a>
			...
			<script>function logout(){
	             var ask = window.confirm("Are sure want to log out?");
	               if (ask) {
            ...
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Home.html" style="padding: 10px 20px;">Home</a>
					...
					</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Service.html" style="padding: 10px 20px;">Service</a>
					</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Booking.html" style="padding: 10px 20px;">Booking</a>
					...
					</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="bookingHistory.html" style="padding: 10px 20px;">My Booking</a>
				</li></ul>
              </div>
            </div>
    ...
    <section class="u-black u-clearfix u-section-1" id="sec-f2f6">
      <div class="u-clearfix u-sheet u-sheet-1">
		...
		<table style="width:90% ">
			...
			<tr>
			<th></th>
			<th><h4>Please input the following information. </h4></th>
			</tr>
			</table>
			<div class="tm-container-fluid">
			<table><th>
			<form id="contact-form" action="UpdatePayment" method="POST" class="tm-contact-form">
				<table align="center">
				<h2> Pay By Online </h2>
					
					<tr><td>Booking ID : </td><td><input type="text" name="BOOKINGID" value="<c:out value="${psn.BOOKINGID}"/>" readonly/><br></td></tr>
					<tr><td>Payment Amount : </td><td><input type="number" name="PAYMENTAMOUNT" value="${psn.PAYMENTAMOUNT}" readonly/><br></td></tr>
					<tr><td>Date : </td><td><input type="date" name="PAYMENTDATE" value="${psn.PAYMENTDATE}" min="2021-07-26" readonly/><br></td></tr>
					<tr><td>Payment Type : </td><td><input type="text" name="PAYMENTTYPE" value="${psn.PAYMENTTYPE}" readonly/><br></td></tr>
					<tr><td>Payment ID : </td><td><input type="number" name="PAYMENTID" value="${psn.PAYMENTID}" readonly/><br></td></tr>
					<tr><td>CVV Number : </td><td><input type="number" name="CVV" value="" required /><br></td></tr>
					<tr><td>Name on Card : </td><td><input type="text" name="CARDNAME" value="" required /><br></td></tr>
					<tr><td>Bank : </td><td><input type="text" name="BANKNAME" value="" required /><br></td></tr>
					<tr><td>Card No. : </td><td><input type="text" name="CARDNUM" value="" required /><br></td></tr>
					
					
		          	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
		          	<table class="tm-right">
					<th align="left"><button type="submit" class="w3-btn w3-block w3-gray">Next</button></th>  
		          	<th>&nbsp&nbsp&nbsp</th>
		          	<th align="right"><button type="reset" class="w3-btn w3-block w3-gray">Clear</button></th>
		          	</tr>
		          	</table>        	
		        </form></th>
		        
		        
		        <th width="5%" ><div class="vl"></div></th><th>
		        
		        
		        
		        <form id="contact-form" action="UpdatePaymentC" method="POST" class="tm-contact-form">
				<table align="center">
					<h2> Pay Cash On The Spot </h2>
					
					<tr><td>Booking ID: </td><td><input type="text" name="BOOKINGID" value="<c:out value="${psn.BOOKINGID}"/>" readonly/><br></td></tr>
					<tr><td>Payment Amount: </td><td><input type="number" name="PAYMENTAMOUNT" value="${psn.PAYMENTAMOUNT}" readonly/><br></td></tr>
					<tr><td>Date: </td><td><input type="date" name="PAYMENTDATE" value="${psn.PAYMENTDATE}" min="2021-07-26" readonly/><br></td></tr>
					<tr><td>Payment Type: </td><td><input type="text" name="PAYMENTTYPE" value="${psn.PAYMENTTYPE}" readonly/><br></td></tr>
					<tr><td>Payment ID: </td><td><input type="text" name="PAYMENTID" value="${psn.PAYMENTID}" readonly/><br></td></tr>
					<tr><td>Payment Adress : </td><td><textarea  name="PAYMENTLOCATION" value="" rows="5" cols="30" style="background-color:gray;" required></textarea><br></td></tr>
		          	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
		          	<table class="tm-right" align="right">
					<th align="left"><button type="submit" class="w3-btn w3-block w3-gray">Next</button></th>  
		          	<th>&nbsp&nbsp&nbsp</th>
		          	<th align="right"><button type="reset" class="w3-btn w3-block w3-gray">Clear</button></th>
		          	</tr>
